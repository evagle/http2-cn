超文本传输协议（HTTP）是一个非常成功的协议。 However, how HTTP/1.1 uses the underlying transport ([RFC7230], Section 6) has several characteristics that have a negative overall effect on application performance today.
